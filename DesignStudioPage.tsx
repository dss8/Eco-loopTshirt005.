...
import { Sparkles, Leaf, Palette, Type, Shirt, ArrowRight, Download, Wand2, Droplets, Wind, Recycle, RotateCcw, Check, ShoppingCart } from 'lucide-react';
...
export default function DesignStudioPage() {
  ...
  useEffect(() => {
    ...
    // Design overlay (generated or pattern)
    if (generatedDesign) {
      // Simulate a design area
      ...
      ctx.fillText('AI Design:', centerX, centerY - 30);
      ctx.fillStyle = '#fffefa';
      ctx.font = '14px Inter';
      const words = generatedDesign.split(' ');
      words.forEach((word, i) => {
        ctx.fillText(word, centerX, centerY + i * 18);
      });
    }
  ...
  }, [tshirtColor, text, textColor, selectedFont, textPosition, generatedDesign, selectedMaterial]);
